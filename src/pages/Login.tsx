    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm animate-slide-up">
          ...
          <p className="text-muted-foreground mt-1 mb-8">Sign in with your university Gmail</p>

          <Button variant="outline" className="w-full h-11 mb-6" onClick={() => navigate("/")}>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <Input type="email" placeholder="you@university.edu" value={email} onChange={(e) => setEmail(e.target.value)} className="pl-9" />
              </div>
            </div>
            <div>
